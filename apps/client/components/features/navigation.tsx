...
import { Search01Icon, CancelIcon, Menu11Icon, Notification02Icon  } from "@hugeicons/core-free-icons";
        ...
        <nav className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/search" aria-label="Search"
              ...
              <HugeiconsIcon icon={Search01Icon} /><span className="text-sm">Search…</span>
            </Link>
            {/* Search icon (xs) */}
            <Link href="/search" aria-label="Search"
            ...
            <button onClick={() => setMobileOpen((o) => !o)} aria-label="Toggle menu"
              ...
              {mobileOpen ? <HugeiconsIcon icon={CancelIcon} /> : <HugeiconsIcon icon={Menu11Icon} />}
            </button>
          </div>
        </nav>
      </header>
                ...
                <div className="flex-1 overflow-y-auto px-4 py-4">
                  ...
                  {isAuthenticated && currentUser && (
                    <button
                      ...
                      <span className="flex items-center gap-2"><HugeiconsIcon icon={Notification02Icon} /> Activity</span>
                      {activityCount > 0 && (
