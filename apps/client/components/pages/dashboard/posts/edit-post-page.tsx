...
import {
  ...
  Loader2, AlertCircle, Mail, Users, BookOpen,
    ...
    <div className="w-full space-y-6">
      ...
      {cropFile ? (
        <div className="overflow-hidden rounded-2xl border border-border">
          <ImageCropper file={cropFile} aspect={16 / 6} cropShape="rect"
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-border bg-card p-4">
            ...
            <textarea value={excerpt} onChange={(e) => setExcerpt(e.target.value)}
              placeholder="A short summary readers will see in the feed…" rows={3} maxLength={500}
          ...
          <div className="rounded-2xl border border-border bg-card p-4">
            ...
            <Select value={seriesId || "_none"} onValueChange={(v) => {
                if (v === null) return;
                setSeriesId(v === "_none" ? "" : v);
              }}>
              <SelectTrigger className="w-full rounded-xl border-border bg-background text-sm">
            ...
            {seriesId && (
              <div className="mt-2">
                ...
                <input type="number" min={1} value={seriesOrder}
          ...
          <div className="rounded-2xl border border-border bg-card p-4">
            ...
            <p className="mb-3 text-xs text-muted-foreground">
              Invite creators you follow. Accepted co-authors are shown with a green badge.
            </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {ca.status !== "accepted" && (
                        <button onClick={() => removeCoAuthor(ca.userId)}
                          className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-muted-foreground hover:bg-accent hover:text-destructive">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea value={newSeriesDesc} onChange={(e) => setNewSeriesDesc(e.target.value)}
              placeholder="What is this series about?" rows={2}
